...
export default async function NewOfferPage() {
  ...
  const nextNumber = await getNextDocumentNumberPreview('OFFER')

  return (
    <Layout>
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-amber-900">Offerte maken</h1>
          <p className="mt-1 text-sm text-amber-800">
            Vul de gegevens hieronder in. Je ziet alvast het volgende offertenummer.
          </p>
        </div>
        <div className="mb-6 rounded-2xl border border-amber-100 bg-white p-6 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-6">
            ...
            <div className="text-right">
              <div className="text-2xl font-semibold tracking-[0.4em] text-amber-800">OFFERTE</div>
              <div className="mt-4 space-y-2 text-sm text-amber-900">
                <div className="flex justify-between gap-6">
                  <span className="text-amber-700">Offertenummer</span>
